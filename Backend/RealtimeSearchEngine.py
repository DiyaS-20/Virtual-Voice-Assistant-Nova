...
try:
    with open("C:\\Users\\jordanj\\Desktop\\AI-Voice-Assistant\\Data\\ChatLog.json", "r") as f:
        messages = load(f)
except:
    with open("C:\\Users\\jordanj\\Desktop\\AI-Voice-Assistant\\Data\\ChatLog.json", "w") as f:
        dump([], f)
...
def Information():
    ...
    day = current_date_time.strftime("%A")  # Fixed: "%A" for the full day name.
    date = current_date_time.strftime("%d")
    month = current_date_time.strftime("%B")  # Fixed: "%B" for the full month name.
...
def RealtimeSearchEngine(prompt):
    ...
    # Append the response to the chatbot messages.
    ...
    # Return the answer after modification.
