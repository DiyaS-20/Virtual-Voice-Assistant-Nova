...
with open("C:\\Users\\jordanj\\Desktop\\AI-Voice-Assistant\\Data\\Voice.html", "w") as f:
    f.write(HtmlCode)
...
#Function to modify a query to ensure proper puncutation and formatting
    ...
    while True:
        try:
             ...
             if Text:
                ...
                #If the inout language is english, return the modified query
                if InputLanguage.lower() == "en" or "en" in InputLanguage.lower():
                    return QueryModifier(Text)
                else:
                    #If the input language is not english, translate the text and return it
                    SetAssistantStatus("Translating.....")
                    return QueryModifier(UniversalTranslation(Text))
